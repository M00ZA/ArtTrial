...
export const ArtistsColumns = [
  ...
  createColumn('actions', 'Actions', (params: any) => (
    <GridActionsContainer
      actions={[
        createActionObject(`/admin/artists/${params.row._id}/edit`, 'edit', Edit),
        createActionObject(`/admin/artists/${params.row._id}/delete`, 'Delete', Trash),
        createActionObject(`/admin/artists/${params.row._id}/view`, 'View', Eye),
      ]}
    />
