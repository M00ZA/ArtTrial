  ...
  return (
    <div>
      <PageTitle label='Subjects' icon={Captions}>
        <Link href='/admin/subjects/add'><Button><Plus className='mr-2 size-5' /> New</Button></Link>
        <Button variant='outline'><Trash className='mr-2 size-5' /> Delete</Button>
      </PageTitle>

      <DataTable 
        rows={subjectsQuery?.data?.data?.data && subjectsQuery.data.data.data.subjects}
