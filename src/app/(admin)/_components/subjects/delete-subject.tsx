...
export const DeleteSubjectComponent = () => {
  ...
  return (
    <div>
      <div className="w-[50%]">
        <PageTitle icon={Trash} label={<span className='flex items-center gap-2'>Delete Subject <Link className='text-sm text-gray-400 font-normal' href={`/admin/subjects/${subject?._id}`}>/{subject?.title} ({subject.slug})</Link></span>} />
        <DeleteAction 
          icon={Trash}
