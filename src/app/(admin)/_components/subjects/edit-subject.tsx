...
export const EditSubjectComponent = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: zod.infer<typeof EditSubjectSchema>) =>
      updateSubject(id as string, values),
    onSuccess: (d) => {
      if (d.data?.code === 200) {
    ...
    <div>
      ...
      {subject && (
        <Form {...form}>
            ...
            label={
              <span className="flex items-center gap-2">
                ...
                <Link
                  ...
                  href={`/admin/subjects/${subject?.id}/view`}
                >
          ...
          <form
            onSubmit={form.handleSubmit(updateSubjectHandler)}
