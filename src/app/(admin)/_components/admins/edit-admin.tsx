...
export const EditAdminComponent = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: zod.infer<typeof EditAdminSchema>) =>
      updateAdmin(id as string, values),
    onSuccess: (d) => {
      if (d.data?.code === 200) {
  ...
  const admin: Admin = getAdminQuery.data?.data?.data;
            ...
            label={
              <span className="flex items-center gap-2">
                ...
                <Link
                  ...
                  href={`/admin/admins/${admin?.id}/view`}
                >
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Select
                      ...
                      {...field}
                      onValueChange={(e: any) => form.setValue("role", e)}
                    >
                      <SelectTrigger>
