...
export const DeleteCategoryComponent = () => {
  ...
  return (
    <div>
      <div className="w-[50%]">
        <PageTitle icon={Trash} label={<span className='flex items-center gap-2'>Delete Category <Link className='text-sm text-gray-400 font-normal' href={`/admin/categories/${category?._id}`}>/{category?.title} ({category.slug})</Link></span>} />
        <DeleteAction 
          icon={Trash}
