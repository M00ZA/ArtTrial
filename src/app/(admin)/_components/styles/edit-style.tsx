...
export const EditStyleComponent = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: zod.infer<typeof EditStyleSchema>) =>
      updateStyle(id as string, values),
    onSuccess: (d) => {
      if (d.data?.code === 200) {
    ...
    <div>
      ...
      {style && (
        <Form {...form}>
            ...
            label={
              <span className="flex items-center gap-2">
                ...
                <Link
                  ...
                  href={`/admin/styles/${style?.id}/view`}
                >
          ...
          <form
            onSubmit={form.handleSubmit(updateStyleHandler)}
