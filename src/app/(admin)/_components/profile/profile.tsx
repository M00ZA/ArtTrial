...
const ProfilePageComponent = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: zod.infer<typeof UpdateMyAdminProfileSchema>) =>
      updateAdminAccount(values),
    onSuccess: (res: any) => {
      console.log(res);
      if (res.data?.code === 200) {
      ...
      <div className="divide-y py-6">
        ...
        <div className="flex">
          ...
          <div className="w-full px-4 pb-2">
            <Form {...pictureForm}>
              <form
                onSubmit={pictureForm.handleSubmit(pictureActionHandler)}
              ...
              >
                ...
                <Button
                  size="sm"
                  disabled={
                    changeImageMutation.status === "pending" ? true : false
                  }
                  className="w-fit text-xs"
                >
                  <span>
                    {changeImageMutation.status === "pending" ? (
        ...
        <div className="flex">
          ...
          <div className="w-full px-4 pb-4">
            <Form {...form}>
              <form
                onSubmit={form.handleSubmit(updateAdminHandler)}
                className="flex flex-col gap-y-1 mt-5"
              >
                <FormField
