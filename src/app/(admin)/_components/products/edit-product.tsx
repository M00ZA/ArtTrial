...
export const EditProductComponent = () => {
  ...
  const updateMutation = useMutation({
    mutationFn: (values: zod.infer<typeof EditProductSchema>) => updateProduct(id as string, values),
    onSuccess: (d) => {
      console.log(d)
      if (d.data?.code === 200) {
  ...
  return (
    <div>
      ...
      {product && (
        ...
        <Form {...form}>
          <PageTitle icon={Edit} label={<span className='flex items-center gap-2'>Edit Product <Link className='text-sm text-gray-400 font-normal' href={`/admin/products/${product._id}/view`}>/{product?._id}</Link></span>} />

          <form onSubmit={form.handleSubmit(updateProductHandler)} className='flex flex-col gap-y-3 mt-5 w-[50%]'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input defaultValue={product?.title} {...field} type='text' placeholder='Title' />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea defaultValue={product?.description} {...field} rows={9} placeholder='Description' />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input defaultValue={product?.width} {...register('width', {
                      valueAsNumber: true
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input defaultValue={product?.height} {...register('height', {
                      valueAsNumber: true
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input defaultValue={product?.depth} {...register('depth', {
                      valueAsNumber: true
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input defaultValue={product?.material} {...field} type='text' placeholder='Material' />
                  </FormControl>
                  <FormDescription />
                  <FormMessage />
                </FormItem>
