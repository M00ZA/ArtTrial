...
export const ViewProductComponent = () => {
  ...
  return (
    <div>
      <PageTitle
        label={<span className="flex items-center gap-2">View Product</span>}
      >
        <Link href={`/admin/products/${id}/edit`}>
          <Button variant="outline">Edit</Button>
        </Link>
        <Link href={`/admin/products/${id}/delete`}>
      ...
      <div className="flex gap-5">
        <section className="w-[600px]">
          <div className="mb-4 rounded-md flex items-center justify-center mb-2">
            <Image
              ...
              width={300}
              height={300}
              className="h-[500px] w-[500px] rounded-md ring-2 ring-primary hover:scale-[102.5%] transition-all"
            />
          </div>
        ...
        <section className="w-full">
          <header>
            ...
            <p className="bg-gray-100 p-2 rounded-md shadow-sm text-xs border leading-6 my-2">
              {product?.description}
            </p>
          </header>
          <section className="flex justify-between items-center pb-2 border-b">
            ...
            <ul className="flex gap-1">
              <li className="bg-gray-100 p-2 rounded-md shadow-sm text-xs border">
                {product?.width}
              </li>
              <li className="bg-gray-100 p-2 rounded-md shadow-sm text-xs border">
                {product?.height}
          ...
          <section className="divide-y">
            <div className="flex justify-between items-center py-2">
              ...
              <div className="font-bold">
                {product?.owner?.name ?? "Not-Available"}
              </div>
            </div>
            <div className="flex justify-between items-center py-2">
              <div>Material</div>
